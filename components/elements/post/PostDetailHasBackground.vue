<template>
    <div class="ps-post--detail ps-post--parallax">
        <div class="ps-post__header bg--cover">
            <div class="container">
                <h4>Technology</h4>
                <h1>
                    Harman Kadon Onyx Studio Mini, <br />
                    Reviews & Experiences
                </h1>
        ...
        <div class="container">
            <div class="ps-post__content">
                ...
                <blockquote class="ps-blockquote">
                    ...
                    <span class="ps-blockquote__author">JELLY CRISTIANA</span>
                </blockquote>
                <p>
                ...
                <p>
                    ...
                    <strong>According to Kross</strong>, when you think of
                    yourself as another person, it allows you give yourself more
